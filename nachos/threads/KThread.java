...
public class KThread {
	...
	public static void selfTest() {
		...
		new PingTest(0).run();
		System.out.println("testing with child finished");
		joinTestChildFinished();
		System.out.println("testing with child not finished");
		joinTestChildNotFinished();
		//System.out.println("testing mutliple joins on single child: Assertion expected");
		//joinTestMultipleJoinOnSingleChild();
		System.out.println("testing with multiple children");
	...
	private static void joinTestChildFinished () {
	...
	// Simple test for the situation where the child finishes after
	// the parent calls join on it.

	private static void joinTestChildNotFinished () {
		KThread child1 = new KThread( new Runnable () {
			public void run() {
				for(int i = 0; i<5; i++)
				System.out.println("I (heart) Nachos!");
	...
	// Simple test for the situation where multiple test get called for child
	// assertion should be expected

	private static void joinTestMultipleJoinOnSingleChild () {
		KThread child1 = new KThread( new Runnable () {
			public void run() {
				for(int i = 0; i<2; i++)
					System.out.println("I (heart) Nachos!");
	...
	// assertion expected
	private static void joinTestOnSelf(){
		currentThread.join();
	}


	// Simple test for the situation where multiple join get called for different child


	private static void joinTestMultipleJoinOnChild () {
		KThread child1 = new KThread( new Runnable () {
			public void run() {
				for(int i = 0; i<2; i++)
					System.out.println("I (heart) Nachos!");
